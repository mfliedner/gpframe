...
struct _streamh {
	...
	char *distribformatfile; /* name of associated Distributed Format File */
  char **tag_sect  ;  /*tags associated with the different sections*/
  char **mach_sect  ;  /*machines associated with the different sections*/
